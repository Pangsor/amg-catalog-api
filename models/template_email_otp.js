function getTemplateEmailOTP(dataBody){
  const templateEmailOTP = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
  <html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml">
    <head>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1">
      <meta http-equiv="X-UA-Compatible" content="IE=Edge">
      <!--user entered Head Start--><link href="https://fonts.googleapis.com/css?family=Muli&display=swap" rel="stylesheet">
      <![endif]-->
      <style type="text/css">
        body, p, div {
          font-family: inherit;
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
                                                                  <span style="font-size: 43px">OTP Login!</span>
                                                                </td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                                                ...
                                                                <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                  <div>
                                                                    <div style="font-family: inherit; text-align: center">
                                                                      <span style="font-size: 35px"><span style="text-transform:capitalize">${dataBody.nama_lkp}</span>, You have logged in.</span>
                                                                    </div>
                                                                    <div></div>
                                                                  </div>
                                                                </td>
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                  <div>
                                                                    <div style="font-family: inherit; text-align: center">
                                                                      <span style="font-size: 18px">Please verify your OTP. Your OTP is below,</span>
                                                                      <span style="font-size: 18px">.</span>
                                                                    </div>
                                                                    <div style="font-family: inherit; text-align: center">
                                                                      <span style="color: #132d60; font-size: 18px"><strong>Thanks!&nbsp;</strong></span>
                                                                    </div>
                                                                    <div></div>
                                                                  </div>
                                                                </td>
                                                                    ...
                                                                    <tbody>
                                                                      <tr>
                                                                        <td align="center" bgcolor="#ffbe00" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                          <div style="background-color:#132d60; border:1px solid #132d60; border-color:#132d60; border-radius:0px; border-width:1px; color:white; display:inline-block; font-size:44px; font-weight:normal; letter-spacing:10px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;">${dataBody.kode_otp}</div>
                                                                        </td>
                                                                      </tr>
                                                                    </tbody>
                                                                  </table>
  ...
  return templateEmailOTP;
}

exports.getTemplateEmailOTP = getTemplateEmailOTP;