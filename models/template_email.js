function getTemplateEmail(dataBody){
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
                                                                  <span style="font-size: 43px">Verification Email</span>
                                                                </td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                                                ...
                                                                <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                  <div>
                                                                    <div style="font-family: inherit; text-align: center">
                                                                      <span style="font-size: 35px">Thanks for signup the Catalog, <span style="text-transform:capitalize">${String(dataBody.nama_lkp).toLowerCase()}</span>!&nbsp;</span>
                                                                    </div>
                                                                    <div></div>
                                                                  </div>
                                                                </td>
                                                                ...
                                                                <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                  <div>
                                                                    <div style="font-family: inherit; text-align: center">
                                                                      ...
                                                                      <span style="color: #000000; font-size: 18px; font-family: arial,helvetica,sans-serif"></span>
                                                                      <span style="font-size: 18px">.</span>
                                                                    </div>
                                                                    <div style="font-family: inherit; text-align: center">
                                                                      <span style="color: #132d60; font-size: 18px"><strong>Thank you!&nbsp;</strong></span>
                                                                    </div>
                                                                    <div></div>
                                                                  </div>
                                                                </td>
                                                                    ...
                                                                    <tbody>
                                                                      <tr>
                                                                        <td align="center" bgcolor="#ffbe00" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                          <a href="${dataBody.link_verifikasi}" style="background-color:#132d60; border:1px solid #132d60; border-color:#132d60; border-radius:0px; border-width:1px; color:white; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;" target="_blank">Verification Email Now!</a>
                                                                        </td>
                                                                      </tr>
                                                                    </tbody>
                                                                  </table>
...
exports.getTemplateEmail = getTemplateEmail;