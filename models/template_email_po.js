function getTemplateEmailPO(dataBody){
  const templateEmailPO = `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
                                                                  <span style="font-size: 43px">Canceled Order!</span>
                                                                </td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                                                ...
                                                                <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                  <div>
                                                                    <div style="font-family: inherit; text-align: center">
                                                                      <span style="font-size: 35px"><span style="text-transform:capitalize">${dataBody.nama_lkp}</span>, Your order was canceled.</span>
                                                                    </div>
                                                                    <div></div>
                                                                  </div>
                                                                </td>
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                  <div>
                                                                    <div style="font-family: inherit; text-align: center">
                                                                      <span style="font-size: 35px"><span style="text-transform:capitalize">No PO</span></span>
                                                                    </div>
                                                                    <div></div>
                                                                  </div>
                                                                </td>
                                                                    ...
                                                                    <tbody>
                                                                      <tr>
                                                                        <td align="center" bgcolor="#ffbe00" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                          <div style="background-color:#132d60; border:1px solid #132d60; border-color:#132d60; border-radius:0px; border-width:1px; color:white; display:inline-block; font-size:38px; font-weight:normal; letter-spacing:10px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;">${dataBody.no_po}</div>
                                                                        </td>
                                                                      </tr>
                                                                    </tbody>
                                                                  </table>
  ...
  return templateEmailPO;
}

exports.getTemplateEmailPO = getTemplateEmailPO;